...
class GaussianDiffusion(nnx.Module):
    def __init__(
        ...
        self.betas = nnx.BatchStat(betas)
        self.alphas = nnx.BatchStat(alphas)
        self.alphas_cumprod = nnx.BatchStat(alphas_cumprod)
        self.alphas_cumprod_prev = nnx.BatchStat(alphas_cumprod_prev)
        ...
        self.posterior_log_variance_clipped = nnx.BatchStat(jnp.log(self.posterior_variance.value))
