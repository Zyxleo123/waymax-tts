...
from metrics.common import positions_xy, speed
...
def compute_proximity_metric(
	...
	ego_centers = positions_xy(trajectories)
...
def compute_yield_metric(
	...
	target_idx = int(matches[0])
	from metrics.common import proposal_polygons

	ego_polygons = proposal_polygons(world, trajectories, scale=world.collision_scale)[..., :4, :]
...
def compute_overtake_metric(
	...
	ego_speed = speed(trajectories, world=world, dt_s=world.prediction_dt_s)
