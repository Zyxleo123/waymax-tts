...
def parse_eval_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="SDC route path count in the dataset. Default: the ScenarioMax layout (10). "
        "Raw WOMD 1.3.1 tf_example needs 45.",
    )
    parser.add_argument(
        "--num_points_per_sdc_path",
        type=int,
        default=None,
        help="Points per SDC route. Default: the ScenarioMax layout (300). Raw WOMD needs 800.",
    )
    parser.add_argument(
        "--plot-failures",
        "-pf",
...
def main():
    ...
    data_generator = make_data_generator(
        ...
        seed=eval_args.seed,
        repeat=1,
        num_paths=eval_args.num_sdc_paths,
        num_points_per_path=eval_args.num_points_per_sdc_path,
    )
