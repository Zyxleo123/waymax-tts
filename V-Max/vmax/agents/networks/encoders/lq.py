...
class LQEncoder(nn.Module):
    ...
    def __call__(self, obs: jax.Array) -> jax.Array:
        ...
        token_masks = [sdc_traj_valid_mask, other_traj_valid_mask, rg_valid_mask, tl_valid_mask, gps_path_mask]
        ...
        # [B, N, D]
        input = jnp.concatenate(encodings, axis=1)
        mask = jnp.concatenate(token_masks, axis=1)  # [B, N]
